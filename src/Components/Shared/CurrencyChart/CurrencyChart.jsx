            ...
            <div className="my-32">
                ...
                <div className="flex md:items-center justify-between mt-10 bg-Primary md:flex-row flex-col px-4 py-5">
                    ...
                    <div className="max-w-[400px]  w-full md:mt-0 mt-4">
                        <input onChange={searchchange} value={inputField} placeholder="Enter currency name" type="text" className="max-w-[400px]  w-full px-3 py-3 focus:outline-none" />
                    </div>
                </div>
                ...
                <div className="flex justify-center mt-5">
                    {fullData.length > 20 && (
                        <button
                            ...
                            className="bg-Primary text-white  text-xl px-3 py-2 rounded-lg flex max-w-[160px] items-center gap-2"
                        >
