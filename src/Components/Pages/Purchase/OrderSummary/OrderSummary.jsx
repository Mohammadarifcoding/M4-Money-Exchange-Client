        ...
        <div>
            {allTheitem?.length ? (
                <div className=" lg:mt-32 mt-14">
                    <div className="">
                        <h2 className="text-Primary font-medium sm:text-2xl text-2xl  ">Order Summary </h2>
                        <div className="flex items-center  flex-col  mt-10 gap-3">
                            {allTheitem?.map((item) => (
                                <OrderItem key={item} allTheitem={allTheitem} setAllTheItem={setAllTheItem} handleDelete={handleDelete} item={item}></OrderItem>
                            ))}
                        </div>
                    </div>
                </div>
