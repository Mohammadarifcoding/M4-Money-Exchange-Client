            ...
            {nextFrom == 3 ? (
                <div>
                    <div className="flex lg:mb-20 mb-7 deleteButton justify-end ">
                        <button onClick={handlePrint} className="px-4 py-2 bg-red-600 text-white">
                            Print
                        </button>
                    </div>
                        ...
                        <table className="min-w-full">
                            <thead>
                                <tr className="border-b  border-gray-400">
                                    <th style={{ backgroundColor: '#[#1a0d43]' }} className="px-4 py-2  text-left bg-[#1a0d43] border-r border-gray-400  text-white">
                                        Currency
                                    </th>
                    ...
                    <div className="overflow-hidden border mt-7 border-gray-400">
                        ...
                        <div className="min-w-full">
                            <div className="flex border-b border-gray-400">
                                <div className="py-3 border-r border-gray-400 font-semibold md:w-[20%] w-[30%] text-center bg-[#1a0d43] text-white">Full Name</div>
                                <div className="border-gray-400 bg-gray-200 py-3 px-4 w-[80%] text-start">{Order?.Name}</div>
                            </div>
                            <div className="flex border-b border-gray-400">
                                <div className="py-3 border-r border-gray-400 font-semibold md:w-[20%] w-[30%] text-center bg-[#1a0d43] text-white">Email</div>
                                <div className="border-gray-400 bg-gray-200 py-3 px-4 w-[80%] text-start">{Order?.Email}</div>
                            </div>
                            <div className="flex border-b border-gray-400">
                                <div className="py-3 border-r border-gray-400 font-semibold md:w-[20%] w-[30%] text-center bg-[#1a0d43] text-white">Contact</div>
                                <div className="border-gray-400 bg-gray-200 py-3 px-4 w-[80%] text-start">{Order?.Phone_Number}</div>
                            </div>
                            <div className="flex  border-b border-gray-400">
                                <div className="py-3 border-r border-gray-400 font-semibold md:w-[20%] w-[30%] text-center bg-[#1a0d43] text-white">Address</div>
                                <div className="border-gray-400 bg-gray-200 py-3 px-4 w-[80%] text-start">{Order?.Address}</div>
                            </div>
                            <div className="flex">
                                <div className="py-3 border-r border-gray-400 font-semibold md:w-[20%] w-[30%] text-center bg-[#1a0d43] text-white">Pickup Location</div>
                                <div className="border-gray-400 bg-gray-200 py-3 px-4 w-[80%] text-start">{Order?.CheckingPoint}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-10 flex flex-col gap-3 bg-Primary p-5 text-white">
                        ...
                        <p className="text-sm">
                            Collect your Instore Branch collection order on the same day in between office hours. Kindly read the Terms and Conditions for payments and necessary supporting documents.
                        </p>
                        <p className="text-sm">
                            All orders are accepted subject to stock and denominations availability at your selected branch. A member of our team will be in touch promptly only if the currency booked
                            is not available and advise you of an alternate collection time. Please print the order confirmation receipt and present it at the selected branch counter, or you can quote
                            the reference number with your ID for collection.
                        </p>
                        <p className="text-sm">
                            For Card Payment: Your ID must be in the form of either your valid passport or full UK or European photo driving licence, European ID, along with your payment bank card,
                            which must match the name on the order.
                        </p>
                    </div>
                </div>
            ) : (
