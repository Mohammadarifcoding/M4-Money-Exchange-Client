...
const StoreFind = () => {
    return (
      ...
      <div className="flex lg:flex-row flex-col justify-between items-center">
        <div>
           <h2 className="text-Primary lg:text-6xl sm:text-2xl text-xl  font-semibold lg:text-start text-center">Find your nearest store</h2>
           ...
           <div className="flex lg:justify-start justify-center lg:mt-10 mt-4">
                       <button className="btn  bg-Primary text-white font-normal rounded hover:bg-[#1D2F51]">Currency Exchange near me <IoIosArrowForward /></button>
           </div>
        </div>
