...
const Accordin = () => {
  ...
  const accordionsData = [
    { title: 'How do I place an order for currency exchange?', description: `To place an order for currency exchange with M4, follow these steps:
    ...
    `},
    { title: 'What currencies can I exchange at M4?', description: 'We offer a wide range of 70+ foreign currencies for exchange, including popular options like USD, EUR, JPY, and AUD. For the complete list check our website or contact us directly.'},
    ...
    { title: 'Do you offer international money transfers?', description: 'We offer fast, secure, and efficient international money transfer services via Western Union. Transfer funds to family, friends worldwide! '},
    { title: 'How can I contact customer support if I have questions?', description: 'You can reach our customer support team via phone at 02082622041, or email us at contact@m4fx.co.uk, or visit us during business hours. We’re here to assist you with any queries!'}];
